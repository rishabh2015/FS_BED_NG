...
@Data
public class ProductCacheBO implements Serializable{
	...
	private Map<String, Map> countryWisePrice;
	@JsonIgnore
	...
	private List<Map> colorSizeCombinationList;
