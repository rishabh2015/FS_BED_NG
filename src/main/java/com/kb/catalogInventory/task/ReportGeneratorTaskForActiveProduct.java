...
public class ReportGeneratorTaskForActiveProduct extends KbRunnable {
    ...
    public ReportGeneratorTaskForActiveProduct(SupplierProductDetailService productDetailService, EmailService emailService, @NotNull List<Long> supplierIdList, boolean isActive, String sortOrder, String mailId, int recordsPerPage) {
            ...
            for (Long supplierId : supplierIdList) {
                ...
                while (true) {
                    try {
                        ...
                        List<Map<String, Object>> list = productDetailService.getProductsOnIsActiveFilter(singleSupplierAsList, isActive, sortOrder, pageNum, pageSize);
